...
const AboutSection = () => {
  return (<Section>
    <h1 className=" text-6xl font-extrabold leading-snug">
      Hi, I'm
      <br />
      <span className=" bg-white px-1 italic">Artistic Guru</span>
    </h1>
    <motion.p
    ...
    >
      I make YouTube video to help develops
      <br />
      learn how to build 3D apps
    </motion.p>
    <motion.button
      className={`bg-indigo-600 text-white py-8 px-8
...
const ContactSelection = () => {
  return (
    <Section>
      <h2 className=" text-5xl font-bold">Constact me</h2>
      <div className=" mt-8 p-8 rounded-md bg-white w-96 max-w-full">
        <form>
          ...
          <input
            ...
            focus:ring-inset focus:ring-indigo-600 p-3`}
          />
